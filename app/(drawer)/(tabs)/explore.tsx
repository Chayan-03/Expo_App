...
// import { ChevronRight, Video, Tractor, FileText, PlayCircle } from 'lucide-react-native';
...
//   const [selectedSection, setSelectedSection] = useState<'schemes' | 'machinery' | 'videos'>('schemes');
